...
Gem::Specification.new do |s|
  ...
  s.homepage = 'https://github.com/fitmo/mimemagic'
  s.license = 'MIT'
  ...
  if s.respond_to?(:metadata)
    s.metadata['changelog_uri'] = 'https://github.com/fitmo/mimemagic/blob/master/CHANGELOG.md'
    s.metadata['source_code_uri'] = 'https://github.com/fitmo/mimemagic'
    s.metadata['bug_tracker_uri'] = 'https://github.com/fitmo/mimemagic/issues'
  end
end
